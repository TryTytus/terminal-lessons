...
export function CancelCourseGeneration(arg1) {
  return window['go']['main']['App']['CancelCourseGeneration'](arg1);
}
...
export function StartCourseGeneration(arg1) {
  return window['go']['main']['App']['StartCourseGeneration'](arg1);
}
